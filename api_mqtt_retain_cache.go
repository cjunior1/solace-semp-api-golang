...
func (a *MqttRetainCacheApiService) CreateMsgVpnMqttRetainCache(ctx context.Context, msgVpnName string, body MsgVpnMqttRetainCache, localVarOptionals *MqttRetainCacheApiCreateMsgVpnMqttRetainCacheOpts) (MsgVpnMqttRetainCacheResponse, *http.Response, error) {
	var (
...
func (a *MqttRetainCacheApiService) ReplaceMsgVpnMqttRetainCache(ctx context.Context, msgVpnName string, cacheName string, body MsgVpnMqttRetainCache, localVarOptionals *MqttRetainCacheApiReplaceMsgVpnMqttRetainCacheOpts) (MsgVpnMqttRetainCacheResponse, *http.Response, error) {
	var (
...
func (a *MqttRetainCacheApiService) UpdateMsgVpnMqttRetainCache(ctx context.Context, msgVpnName string, cacheName string, body MsgVpnMqttRetainCache, localVarOptionals *MqttRetainCacheApiUpdateMsgVpnMqttRetainCacheOpts) (MsgVpnMqttRetainCacheResponse, *http.Response, error) {
	var (
