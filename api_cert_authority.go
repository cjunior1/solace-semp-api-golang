...
func (a *CertAuthorityApiService) CreateCertAuthorityOcspTlsTrustedCommonName(ctx context.Context, certAuthorityName string, body CertAuthorityOcspTlsTrustedCommonName, localVarOptionals *CertAuthorityApiCreateCertAuthorityOcspTlsTrustedCommonNameOpts) (CertAuthorityOcspTlsTrustedCommonNameResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *CertAuthorityApiService) ReplaceCertAuthority(ctx context.Context, certAuthorityName string, body CertAuthority, localVarOptionals *CertAuthorityApiReplaceCertAuthorityOpts) (CertAuthorityResponse, *http.Response, error) {
	var (
...
func (a *CertAuthorityApiService) UpdateCertAuthority(ctx context.Context, certAuthorityName string, body CertAuthority, localVarOptionals *CertAuthorityApiUpdateCertAuthorityOpts) (CertAuthorityResponse, *http.Response, error) {
	var (
