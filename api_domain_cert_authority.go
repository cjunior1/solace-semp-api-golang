...
func (a *DomainCertAuthorityApiService) ReplaceDomainCertAuthority(ctx context.Context, certAuthorityName string, body DomainCertAuthority, localVarOptionals *DomainCertAuthorityApiReplaceDomainCertAuthorityOpts) (DomainCertAuthorityResponse, *http.Response, error) {
	var (
...
func (a *DomainCertAuthorityApiService) UpdateDomainCertAuthority(ctx context.Context, certAuthorityName string, body DomainCertAuthority, localVarOptionals *DomainCertAuthorityApiUpdateDomainCertAuthorityOpts) (DomainCertAuthorityResponse, *http.Response, error) {
	var (
