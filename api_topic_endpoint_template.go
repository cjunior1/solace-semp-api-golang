...
func (a *TopicEndpointTemplateApiService) CreateMsgVpnTopicEndpointTemplate(ctx context.Context, msgVpnName string, body MsgVpnTopicEndpointTemplate, localVarOptionals *TopicEndpointTemplateApiCreateMsgVpnTopicEndpointTemplateOpts) (MsgVpnTopicEndpointTemplateResponse, *http.Response, error) {
	var (
...
func (a *TopicEndpointTemplateApiService) ReplaceMsgVpnTopicEndpointTemplate(ctx context.Context, msgVpnName string, topicEndpointTemplateName string, body MsgVpnTopicEndpointTemplate, localVarOptionals *TopicEndpointTemplateApiReplaceMsgVpnTopicEndpointTemplateOpts) (MsgVpnTopicEndpointTemplateResponse, *http.Response, error) {
	var (
...
func (a *TopicEndpointTemplateApiService) UpdateMsgVpnTopicEndpointTemplate(ctx context.Context, msgVpnName string, topicEndpointTemplateName string, body MsgVpnTopicEndpointTemplate, localVarOptionals *TopicEndpointTemplateApiUpdateMsgVpnTopicEndpointTemplateOpts) (MsgVpnTopicEndpointTemplateResponse, *http.Response, error) {
	var (
