...
func (a *ClientProfileApiService) CreateMsgVpnClientProfile(ctx context.Context, msgVpnName string, body MsgVpnClientProfile, localVarOptionals *ClientProfileApiCreateMsgVpnClientProfileOpts) (MsgVpnClientProfileResponse, *http.Response, error) {
	var (
...
func (a *ClientProfileApiService) ReplaceMsgVpnClientProfile(ctx context.Context, msgVpnName string, clientProfileName string, body MsgVpnClientProfile, localVarOptionals *ClientProfileApiReplaceMsgVpnClientProfileOpts) (MsgVpnClientProfileResponse, *http.Response, error) {
	var (
...
func (a *ClientProfileApiService) UpdateMsgVpnClientProfile(ctx context.Context, msgVpnName string, clientProfileName string, body MsgVpnClientProfile, localVarOptionals *ClientProfileApiUpdateMsgVpnClientProfileOpts) (MsgVpnClientProfileResponse, *http.Response, error) {
	var (
