...
func (a *AuthenticationOauthProviderApiService) CreateMsgVpnAuthenticationOauthProvider(ctx context.Context, msgVpnName string, body MsgVpnAuthenticationOauthProvider, localVarOptionals *AuthenticationOauthProviderApiCreateMsgVpnAuthenticationOauthProviderOpts) (MsgVpnAuthenticationOauthProviderResponse, *http.Response, error) {
	var (
...
func (a *AuthenticationOauthProviderApiService) ReplaceMsgVpnAuthenticationOauthProvider(ctx context.Context, msgVpnName string, oauthProviderName string, body MsgVpnAuthenticationOauthProvider, localVarOptionals *AuthenticationOauthProviderApiReplaceMsgVpnAuthenticationOauthProviderOpts) (MsgVpnAuthenticationOauthProviderResponse, *http.Response, error) {
	var (
...
func (a *AuthenticationOauthProviderApiService) UpdateMsgVpnAuthenticationOauthProvider(ctx context.Context, msgVpnName string, oauthProviderName string, body MsgVpnAuthenticationOauthProvider, localVarOptionals *AuthenticationOauthProviderApiUpdateMsgVpnAuthenticationOauthProviderOpts) (MsgVpnAuthenticationOauthProviderResponse, *http.Response, error) {
	var (
