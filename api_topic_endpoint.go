...
func (a *TopicEndpointApiService) CreateMsgVpnTopicEndpoint(ctx context.Context, msgVpnName string, body MsgVpnTopicEndpoint, localVarOptionals *TopicEndpointApiCreateMsgVpnTopicEndpointOpts) (MsgVpnTopicEndpointResponse, *http.Response, error) {
	var (
...
func (a *TopicEndpointApiService) ReplaceMsgVpnTopicEndpoint(ctx context.Context, msgVpnName string, topicEndpointName string, body MsgVpnTopicEndpoint, localVarOptionals *TopicEndpointApiReplaceMsgVpnTopicEndpointOpts) (MsgVpnTopicEndpointResponse, *http.Response, error) {
	var (
...
func (a *TopicEndpointApiService) UpdateMsgVpnTopicEndpoint(ctx context.Context, msgVpnName string, topicEndpointName string, body MsgVpnTopicEndpoint, localVarOptionals *TopicEndpointApiUpdateMsgVpnTopicEndpointOpts) (MsgVpnTopicEndpointResponse, *http.Response, error) {
	var (
