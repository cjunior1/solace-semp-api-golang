...
func (a *QueueTemplateApiService) CreateMsgVpnQueueTemplate(ctx context.Context, msgVpnName string, body MsgVpnQueueTemplate, localVarOptionals *QueueTemplateApiCreateMsgVpnQueueTemplateOpts) (MsgVpnQueueTemplateResponse, *http.Response, error) {
	var (
...
func (a *QueueTemplateApiService) ReplaceMsgVpnQueueTemplate(ctx context.Context, msgVpnName string, queueTemplateName string, body MsgVpnQueueTemplate, localVarOptionals *QueueTemplateApiReplaceMsgVpnQueueTemplateOpts) (MsgVpnQueueTemplateResponse, *http.Response, error) {
	var (
...
func (a *QueueTemplateApiService) UpdateMsgVpnQueueTemplate(ctx context.Context, msgVpnName string, queueTemplateName string, body MsgVpnQueueTemplate, localVarOptionals *QueueTemplateApiUpdateMsgVpnQueueTemplateOpts) (MsgVpnQueueTemplateResponse, *http.Response, error) {
	var (
