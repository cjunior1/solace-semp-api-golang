...
func (a *ReplicatedTopicApiService) CreateMsgVpnReplicatedTopic(ctx context.Context, msgVpnName string, body MsgVpnReplicatedTopic, localVarOptionals *ReplicatedTopicApiCreateMsgVpnReplicatedTopicOpts) (MsgVpnReplicatedTopicResponse, *http.Response, error) {
	var (
...
func (a *ReplicatedTopicApiService) ReplaceMsgVpnReplicatedTopic(ctx context.Context, msgVpnName string, replicatedTopic string, body MsgVpnReplicatedTopic, localVarOptionals *ReplicatedTopicApiReplaceMsgVpnReplicatedTopicOpts) (MsgVpnReplicatedTopicResponse, *http.Response, error) {
	var (
...
func (a *ReplicatedTopicApiService) UpdateMsgVpnReplicatedTopic(ctx context.Context, msgVpnName string, replicatedTopic string, body MsgVpnReplicatedTopic, localVarOptionals *ReplicatedTopicApiUpdateMsgVpnReplicatedTopicOpts) (MsgVpnReplicatedTopicResponse, *http.Response, error) {
	var (
