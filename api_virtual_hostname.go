...
func (a *VirtualHostnameApiService) ReplaceVirtualHostname(ctx context.Context, virtualHostname string, body VirtualHostname, localVarOptionals *VirtualHostnameApiReplaceVirtualHostnameOpts) (VirtualHostnameResponse, *http.Response, error) {
	var (
...
func (a *VirtualHostnameApiService) UpdateVirtualHostname(ctx context.Context, virtualHostname string, body VirtualHostname, localVarOptionals *VirtualHostnameApiUpdateVirtualHostnameOpts) (VirtualHostnameResponse, *http.Response, error) {
	var (
