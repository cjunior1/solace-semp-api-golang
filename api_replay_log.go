...
func (a *ReplayLogApiService) CreateMsgVpnReplayLog(ctx context.Context, msgVpnName string, body MsgVpnReplayLog, localVarOptionals *ReplayLogApiCreateMsgVpnReplayLogOpts) (MsgVpnReplayLogResponse, *http.Response, error) {
	var (
...
func (a *ReplayLogApiService) ReplaceMsgVpnReplayLog(ctx context.Context, msgVpnName string, replayLogName string, body MsgVpnReplayLog, localVarOptionals *ReplayLogApiReplaceMsgVpnReplayLogOpts) (MsgVpnReplayLogResponse, *http.Response, error) {
	var (
...
func (a *ReplayLogApiService) UpdateMsgVpnReplayLog(ctx context.Context, msgVpnName string, replayLogName string, body MsgVpnReplayLog, localVarOptionals *ReplayLogApiUpdateMsgVpnReplayLogOpts) (MsgVpnReplayLogResponse, *http.Response, error) {
	var (
