...
func (a *MqttSessionApiService) CreateMsgVpnMqttSession(ctx context.Context, msgVpnName string, body MsgVpnMqttSession, localVarOptionals *MqttSessionApiCreateMsgVpnMqttSessionOpts) (MsgVpnMqttSessionResponse, *http.Response, error) {
	var (
...
func (a *MqttSessionApiService) CreateMsgVpnMqttSessionSubscription(ctx context.Context, msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string, body MsgVpnMqttSessionSubscription, localVarOptionals *MqttSessionApiCreateMsgVpnMqttSessionSubscriptionOpts) (MsgVpnMqttSessionSubscriptionResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *MqttSessionApiService) ReplaceMsgVpnMqttSession(ctx context.Context, msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string, body MsgVpnMqttSession, localVarOptionals *MqttSessionApiReplaceMsgVpnMqttSessionOpts) (MsgVpnMqttSessionResponse, *http.Response, error) {
	var (
...
func (a *MqttSessionApiService) ReplaceMsgVpnMqttSessionSubscription(ctx context.Context, msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string, subscriptionTopic string, body MsgVpnMqttSessionSubscription, localVarOptionals *MqttSessionApiReplaceMsgVpnMqttSessionSubscriptionOpts) (MsgVpnMqttSessionSubscriptionResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *MqttSessionApiService) UpdateMsgVpnMqttSession(ctx context.Context, msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string, body MsgVpnMqttSession, localVarOptionals *MqttSessionApiUpdateMsgVpnMqttSessionOpts) (MsgVpnMqttSessionResponse, *http.Response, error) {
	var (
...
func (a *MqttSessionApiService) UpdateMsgVpnMqttSessionSubscription(ctx context.Context, msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string, subscriptionTopic string, body MsgVpnMqttSessionSubscription, localVarOptionals *MqttSessionApiUpdateMsgVpnMqttSessionSubscriptionOpts) (MsgVpnMqttSessionSubscriptionResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
