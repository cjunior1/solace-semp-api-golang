...
func (a *ClientCertAuthorityApiService) ReplaceClientCertAuthority(ctx context.Context, certAuthorityName string, body ClientCertAuthority, localVarOptionals *ClientCertAuthorityApiReplaceClientCertAuthorityOpts) (ClientCertAuthorityResponse, *http.Response, error) {
	var (
...
func (a *ClientCertAuthorityApiService) UpdateClientCertAuthority(ctx context.Context, certAuthorityName string, body ClientCertAuthority, localVarOptionals *ClientCertAuthorityApiUpdateClientCertAuthorityOpts) (ClientCertAuthorityResponse, *http.Response, error) {
	var (
