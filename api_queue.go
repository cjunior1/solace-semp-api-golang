...
func (a *QueueApiService) CreateMsgVpnQueue(ctx context.Context, msgVpnName string, body MsgVpnQueue, localVarOptionals *QueueApiCreateMsgVpnQueueOpts) (MsgVpnQueueResponse, *http.Response, error) {
	var (
...
func (a *QueueApiService) CreateMsgVpnQueueSubscription(ctx context.Context, msgVpnName string, queueName string, body MsgVpnQueueSubscription, localVarOptionals *QueueApiCreateMsgVpnQueueSubscriptionOpts) (MsgVpnQueueSubscriptionResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *QueueApiService) ReplaceMsgVpnQueue(ctx context.Context, msgVpnName string, queueName string, body MsgVpnQueue, localVarOptionals *QueueApiReplaceMsgVpnQueueOpts) (MsgVpnQueueResponse, *http.Response, error) {
	var (
...
func (a *QueueApiService) UpdateMsgVpnQueue(ctx context.Context, msgVpnName string, queueName string, body MsgVpnQueue, localVarOptionals *QueueApiUpdateMsgVpnQueueOpts) (MsgVpnQueueResponse, *http.Response, error) {
	var (
