...
func (a *AuthorizationGroupApiService) CreateMsgVpnAuthorizationGroup(ctx context.Context, msgVpnName string, body MsgVpnAuthorizationGroup, localVarOptionals *AuthorizationGroupApiCreateMsgVpnAuthorizationGroupOpts) (MsgVpnAuthorizationGroupResponse, *http.Response, error) {
	var (
...
func (a *AuthorizationGroupApiService) ReplaceMsgVpnAuthorizationGroup(ctx context.Context, msgVpnName string, authorizationGroupName string, body MsgVpnAuthorizationGroup, localVarOptionals *AuthorizationGroupApiReplaceMsgVpnAuthorizationGroupOpts) (MsgVpnAuthorizationGroupResponse, *http.Response, error) {
	var (
...
func (a *AuthorizationGroupApiService) UpdateMsgVpnAuthorizationGroup(ctx context.Context, msgVpnName string, authorizationGroupName string, body MsgVpnAuthorizationGroup, localVarOptionals *AuthorizationGroupApiUpdateMsgVpnAuthorizationGroupOpts) (MsgVpnAuthorizationGroupResponse, *http.Response, error) {
	var (
