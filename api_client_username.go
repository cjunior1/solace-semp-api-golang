...
func (a *ClientUsernameApiService) CreateMsgVpnClientUsername(ctx context.Context, msgVpnName string, body MsgVpnClientUsername, localVarOptionals *ClientUsernameApiCreateMsgVpnClientUsernameOpts) (MsgVpnClientUsernameResponse, *http.Response, error) {
	var (
...
func (a *ClientUsernameApiService) ReplaceMsgVpnClientUsername(ctx context.Context, msgVpnName string, clientUsername string, body MsgVpnClientUsername, localVarOptionals *ClientUsernameApiReplaceMsgVpnClientUsernameOpts) (MsgVpnClientUsernameResponse, *http.Response, error) {
	var (
...
func (a *ClientUsernameApiService) UpdateMsgVpnClientUsername(ctx context.Context, msgVpnName string, clientUsername string, body MsgVpnClientUsername, localVarOptionals *ClientUsernameApiUpdateMsgVpnClientUsernameOpts) (MsgVpnClientUsernameResponse, *http.Response, error) {
	var (
