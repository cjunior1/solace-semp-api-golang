...
func (a *JndiApiService) CreateMsgVpnJndiConnectionFactory(ctx context.Context, msgVpnName string, body MsgVpnJndiConnectionFactory, localVarOptionals *JndiApiCreateMsgVpnJndiConnectionFactoryOpts) (MsgVpnJndiConnectionFactoryResponse, *http.Response, error) {
	var (
...
func (a *JndiApiService) CreateMsgVpnJndiQueue(ctx context.Context, msgVpnName string, body MsgVpnJndiQueue, localVarOptionals *JndiApiCreateMsgVpnJndiQueueOpts) (MsgVpnJndiQueueResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *JndiApiService) CreateMsgVpnJndiTopic(ctx context.Context, msgVpnName string, body MsgVpnJndiTopic, localVarOptionals *JndiApiCreateMsgVpnJndiTopicOpts) (MsgVpnJndiTopicResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *JndiApiService) ReplaceMsgVpnJndiConnectionFactory(ctx context.Context, msgVpnName string, connectionFactoryName string, body MsgVpnJndiConnectionFactory, localVarOptionals *JndiApiReplaceMsgVpnJndiConnectionFactoryOpts) (MsgVpnJndiConnectionFactoryResponse, *http.Response, error) {
	var (
...
func (a *JndiApiService) ReplaceMsgVpnJndiQueue(ctx context.Context, msgVpnName string, queueName string, body MsgVpnJndiQueue, localVarOptionals *JndiApiReplaceMsgVpnJndiQueueOpts) (MsgVpnJndiQueueResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *JndiApiService) ReplaceMsgVpnJndiTopic(ctx context.Context, msgVpnName string, topicName string, body MsgVpnJndiTopic, localVarOptionals *JndiApiReplaceMsgVpnJndiTopicOpts) (MsgVpnJndiTopicResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *JndiApiService) UpdateMsgVpnJndiConnectionFactory(ctx context.Context, msgVpnName string, connectionFactoryName string, body MsgVpnJndiConnectionFactory, localVarOptionals *JndiApiUpdateMsgVpnJndiConnectionFactoryOpts) (MsgVpnJndiConnectionFactoryResponse, *http.Response, error) {
	var (
...
func (a *JndiApiService) UpdateMsgVpnJndiQueue(ctx context.Context, msgVpnName string, queueName string, body MsgVpnJndiQueue, localVarOptionals *JndiApiUpdateMsgVpnJndiQueueOpts) (MsgVpnJndiQueueResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *JndiApiService) UpdateMsgVpnJndiTopic(ctx context.Context, msgVpnName string, topicName string, body MsgVpnJndiTopic, localVarOptionals *JndiApiUpdateMsgVpnJndiTopicOpts) (MsgVpnJndiTopicResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
