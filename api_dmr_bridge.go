...
func (a *DmrBridgeApiService) CreateMsgVpnDmrBridge(ctx context.Context, msgVpnName string, body MsgVpnDmrBridge, localVarOptionals *DmrBridgeApiCreateMsgVpnDmrBridgeOpts) (MsgVpnDmrBridgeResponse, *http.Response, error) {
	var (
...
func (a *DmrBridgeApiService) ReplaceMsgVpnDmrBridge(ctx context.Context, msgVpnName string, remoteNodeName string, body MsgVpnDmrBridge, localVarOptionals *DmrBridgeApiReplaceMsgVpnDmrBridgeOpts) (MsgVpnDmrBridgeResponse, *http.Response, error) {
	var (
...
func (a *DmrBridgeApiService) UpdateMsgVpnDmrBridge(ctx context.Context, msgVpnName string, remoteNodeName string, body MsgVpnDmrBridge, localVarOptionals *DmrBridgeApiUpdateMsgVpnDmrBridgeOpts) (MsgVpnDmrBridgeResponse, *http.Response, error) {
	var (
